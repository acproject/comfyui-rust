...
impl IoType {
    pub fn io_type_str(&self) -> String {
        match self {
            ...
            IoType::Llm => "LLM".to_string(),
            IoType::Image => "IMAGE".to_string(),
            IoType::Video => "VIDEO".to_string(),
            IoType::Audio => "AUDIO".to_string(),
            ...
            IoType::ClipVision => "CLIP_VISION".to_string(),
            IoType::StyleModel => "STYLE_MODEL".to_string(),
            IoType::UpscaleModel => "UPSCALE_MODEL".to_string(),
            IoType::Gligen => "GLIGEN".to_string(),
            IoType::Photomaker => "PHOTOMAKER".to_string(),
            IoType::Hypernetwork => "HYPERNETWORK".to_string(),
            IoType::Embedding => "EMBEDDING".to_string(),
    ...
    pub fn from_io_type_str(s: &str) -> Self {
        match s {
            ...
            "CLIP_VISION" => IoType::ClipVision,
            "STYLE_MODEL" => IoType::StyleModel,
            "UPSCALE_MODEL" => IoType::UpscaleModel,
            "GLIGEN" => IoType::Gligen,
            "PHOTOMAKER" => IoType::Photomaker,
            "HYPERNETWORK" => IoType::Hypernetwork,
            "EMBEDDING" => IoType::Embedding,
            "NOISE" => IoType::Noise,
